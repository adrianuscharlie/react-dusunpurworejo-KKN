          ...
          <Row className="mb-4 align-items-center flex-lg-row-reverse p-2">
            ...
            <Col md={6} sm={12} className="text-start mt-5">
              ...
              <div className="lc-block mb-4">
                <div contentEditable="rich">
                  <p className="lead">
                    Kelompok 74 KKN-65 Universitas Sanata Dharma ditempatkan di
                    Dusun Purworejo, Kalurahan Semugih, Kapanewon Rongkop,
                    Kabupaten Gunung Kidul. Pengabdian KKN berlangsung selama
                    kurang lebih satu bulan dan berfokus terhadap pemaksimalan
                    potensi yang ada di dalam Dusun itu sendiri. Dengan adanya
                    kehadiran kami, KKN-65 Universitas Sanata Dharma, diharapkan
                    Dusun Purworejo dapat memanfaatkan potensi yang ada dengan
                    maksimal dengan beberapa program kerja pembantu yang telah
                    kami susun dan laksanakan dalam kurun waktu satu bulan itu.
                  </p>
                </div>
              </div>
            </Col>
